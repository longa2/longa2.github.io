...
#### Coding example
In the case of using AI to provide coding examples, I have never done so, because if AI can be used to generate legitimite solutions, then why would I generate coding examples even if I am just learning.
...
There have been times where actual software engineers have coded using AI in providing for real-world solutions. In other cases, it seems that it has been vibe-coded almost through and through. For one example, looking at the code of Windows 11, one is able to notice that it seems to have been coded purely on AI. Given the performance of Windows 11, it is no wonder why Windows 11 has gotten worse than before. Another example is using AI in coding competitions such as HACC where it could go either way, but for the purposes of a competition, it is used as a simple solution to the problem. As such, although there are times where one can legitimately use AI to generate solutions, while there are other cases where using AI may lead to a worse outcome of a product.

## Challenges and Opportunities:
As far as I have used AI in ICS 314, there have been times where AI was not able to effectively provide for my needs and wants. For one example, there have been a few times where AI was not able to generate code necessary for my task at hand. Otherwise, AI has provided for what I needed, at least for the most part. Thus, as far as how AI can be used in ICS 314, there are real opportunities for it to be used for learning, but there are times when AI may not be able to provide for all the needs of the student using it.

## Comparative Analysis:
As far as using AI in education comparative to traditional teaching methods, there just as many benefits as there are drawbacks. AI is being used as a way in generating solutions and information among other use cases. If it is necessary in garnering information quickly, it can be done with AI within seconds of it "thinking." It could even help with explaing further in detail why the solution is the solution. However, in some cases, it could degrade the educational experience due to it providing an immediate solution to the problems that it is given. Therefore, the student may not retain a practical skill for them to use later on in their career or education. This is where traditional teaching methods are much more effective. Although it may seem tedious to do so, practice makes perfect. Thus, in terms of effective learning and training, doing the raw practice allows for the student to retain the information much more easily.
